...
contract("Test Viddo Token Contract",function(accounts){
  ...
  describe("Check token transfer and balance function",function(){
    ...
    it("Transfer 60 000 000 tokens from owner to another account (accounts[1]).Too many tokens. Transaction should fail.Ballance of accounts[0] (owner) should be unchanged",function(){
